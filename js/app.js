(() => {
    ...
    function initSliders() {
        if (document.querySelector(".popular-page__slider")) new core(".popular-page__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".popular-page__button.swiper-button-prev",
                nextEl: ".popular-page__button.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.4,
        ...
        if (document.querySelector(".response-page__slider")) new core(".response-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
            ...
            loop: true,
            navigation: {
                prevEl: ".response-page__button.swiper-button-prev",
                nextEl: ".response-page__button.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.4,
        ...
        if (document.querySelector(".preview-production__slider ")) new core(".preview-production__slider ", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
...
***************************************************************************** */
    ...
    window.onload = function() {
        var colorItems = document.querySelectorAll(".color-items__color");
        for (var i = 0; i < colorItems.length; i++) colorItems[i].addEventListener("click", (function() {
            for (var j = 0; j < colorItems.length; j++) colorItems[j].classList.remove("active");
